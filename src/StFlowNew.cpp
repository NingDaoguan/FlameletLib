...
bool StFlow::updateSSLagrangian(const vector_fp& solutionRef) const
{
    ...
    // dubug-------- ok
    // check muField
    // std::cout << "Check mu field:" << std::endl;
    // for (int i=0;i<zField.size();i++)
    // {
    //     std::cout << muField[i] << " ";
    // }
    ...
    // std::cout << "rhoField size: " << rhoField.size() << std::endl;
    // std::cout << "velocityField size: " << velocityField.size() << std::endl;
    // std::cout << "TField size: " << TField.size() << std::endl;
    std::cout << "YField size: " << YField.size() << std::endl;
    // std::cout << "muField size: " << muField.size() << std::endl;

...
void counterflowDiffusionFlame(doublereal mdotL, doublereal mdotR, doublereal len)
{
    // data
    ...
    x[gas.speciesIndex("O2")] = 0.21 / fa_stoic;
    x[gas.speciesIndex("N2")] = 0.78 / fa_stoic;
    x[gas.speciesIndex("AR")] = 0.01 / fa_stoic;
    gas.setState_TPX(TinRight, p0, x.data());
...
int main(int argc, char *argv[])
{
    ...
    try {
        counterflowDiffusionFlame(mdotL, mdotR, len);
        return 0;
